...
function main() {
	...
	build_firmware "brcm63xx/generic" "A4001N" "lede-*-A4001N-*.*"
	build_firmware "brcm63xx/generic" "A4001N1" "lede-*-A4001N1-*.*"
	build_firmware "brcm63xx/generic" "AR5381u" "lede-*-AR5381u-*.*"
	build_firmware "brcm63xx/generic" "AR5387un" "lede-*-AR5387un-*.*"
	build_firmware "brcm63xx/generic" "CT-6373" "lede-*-CT-6373-*.*"
	build_firmware "brcm63xx/generic" "HG520v" "lede-*-HG520v-*.*"
	build_firmware "brcm63xx/generic" "HG553" "lede-*-HG553-*.*"
	...
	build_firmware "brcm63xx/generic" "P870HW-51a_v2" "lede-*-P870HW-51a_v2-*.*"
	build_firmware "brcm63xx/generic" "VR-3025u" "lede-*-VR-3025u-*.*"
	build_firmware "brcm63xx/generic" "VR-3025un" "lede-*-VR-3025un-*.*"
	build_firmware "brcm63xx/generic" "WAP-5813n" "lede-*-WAP-5813n-*.*"
	...
	build_firmware "brcm63xx/smp" "P870HW-51a_v2" "lede-*-P870HW-51a_v2-*.*"
	build_firmware "brcm63xx/smp" "VR-3025u" "lede-*-VR-3025u-*.*"
	build_firmware "brcm63xx/smp" "VR-3025un" "lede-*-VR-3025un-*.*"
	build_firmware "brcm63xx/smp" "WAP-5813n" "lede-*-WAP-5813n-*.*"
